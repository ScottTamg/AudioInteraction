package com.audio.demo.audiointeraction.dialog;
...
import com.audio.demo.audiointeraction.MainActivity;
import com.audio.demo.audiointeraction.R;
import com.audio.demo.audiointeraction.SplashActivity;
...
public class MoreInfoDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTextViewContent(mWatchViewrs, R.string.main_viewer, String.valueOf(LocalConfig.mAudience));
        setTextViewContent(mAuthorViewrs, R.string.main_secondAnchor, String.valueOf(LocalConfig.mAuthorSize));
    }
